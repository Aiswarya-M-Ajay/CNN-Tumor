...
image_dir='C:/Users/HP/Artifacts/tumordata'
...
plt.savefig('C:/Users/HP/Artifacts/clone/deep-learning/CNN/tumor_detection/results/tumor_sample_accuracy_plot.png')
...
plt.savefig('C:/Users/HP/Artifacts/clone/deep-learning/CNN/tumor_detection/results/tumor_sample_loss_plot.png')
...
model.save('C:/Users/HP/Artifacts/clone/deep-learning/CNN/tumor_detection/results/model/cnn_tumor.h5')
...
make_prediction(cv2.imread("C:/Users/HP/Artifacts/clone/deep-learning/tumordata/yes/y0.jpg"),model)
print("--------------------------------------\n")
make_prediction(cv2.imread("C:/Users/HP/Artifacts/clone/deep-learning/tumordata/no/no0.jpg"),model)
print("--------------------------------------\n")